...
const MenuBar = () => {
    const { user, setOpenUserManagementTable } = AppStore()
    ...
    const menuItems = [
        ...
        { label: "User Management", children: [{ label: "New", onClick: undefined }, { label: "View", onClick: () => setOpenUserManagementTable(true) }] },
